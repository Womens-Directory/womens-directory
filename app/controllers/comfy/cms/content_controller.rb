...
# Copied from here to add Ahoy tracking to CMS page clicks:
# https://github.com/comfy/comfortable-mexican-sofa/blob/master/app/controllers/comfy/cms/content_controller.rb
...
protected
  ...
  def find_cms_page_by_full_path(full_path)
    ...
    @cms_layout = @cms_page.layout
		...
		ahoy.track :page_viewed, comfy_cms_page_id: @cms_page.id
    @cms_page
